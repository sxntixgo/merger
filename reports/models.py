...
class ReportTemplate(models.Model):
    ...
    sec_cover = models.IntegerField(choices=COVER_SECTION, default=0)
    sec_toc = models.BooleanField(default=True)
    sec_es = models.BooleanField(default=True)
    sec_sor = models.BooleanField(default=True)
    sec_method = models.BooleanField(default=True)
    sec_find = models.BooleanField(default=True)
    sec_find_desc = models.BooleanField(default=True)
    sec_find_evid = models.BooleanField(default=True)
    sec_find_sol = models.BooleanField(default=True)
    sec_conc = models.BooleanField(default=True)

    cover_title = models.CharField(max_length=50, blank=True)
    cover_company_name = models.CharField(max_length=50, blank=True)
    cover_contact_name = models.CharField(max_length=50, blank=True)
    cover_contact_email = models.EmailField(max_length=254, blank=True)
    cover_contact_phone_number = PhoneNumberField(blank=True)

    es_text = models.TextField(blank=True)
    ...
    risk_critical_color = models.IntegerField(choices=COLORS, default=45)
    risk_high_color = models.IntegerField(choices=COLORS, default=30)
    risk_medium_color = models.IntegerField(choices=COLORS, default=51)
    risk_low_color = models.IntegerField(choices=COLORS, default=126)
    risk_info_color = models.IntegerField(choices=COLORS, default=41)
